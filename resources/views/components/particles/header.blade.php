          ...
          <ul class="-mx-3 flex items-center">
            <li>
              <a
                ...
                class="text-body-color hover:text-primary inline-block py-4 px-3 text-sm font-medium"
              >
                About Us
              </a>
            </li>
        ...
        <div class="w-full px-4 md:w-1/3 lg:w-1/2">
          <div class="-mx-3 hidden items-center justify-end md:flex">
            <div class="px-3">
              <div class="relative">
                <select
                  class="text-body-color w-full appearance-none rounded-lg bg-transparent py-3 pr-4 text-sm font-medium outline-none transition"
                >
                ...
                <span
                  class="border-body-color absolute right-0 top-1/2 mt-[-2px] h-2 w-2 -translate-y-1/2 rotate-45 border-r border-b"
                >
                </span>
              </div>
            </div>
  ...
  <div class="border-b border-[#e7e7e7] lg:py-4">
    <div class="container mx-auto">
      ...
      >
        ...
        <div
          class="hidden w-full items-center justify-end px-4 sm:flex lg:justify-between"
        >
          <div class="hidden w-full lg:flex">
            <form
              class="relative flex w-full items-center rounded-md border border-[#e7e7e7] bg-[#f4f7ff]"
            >
              <div class="relative border-r border-[#d9d9d9] py-3 pr-5 pl-4">
                <select
                  class="appearance-none bg-transparent pr-4 text-base font-medium text-black outline-none"
                >
                ...
                <span
                  class="border-body-color absolute right-4 top-1/2 mt-[-2px] h-[6px] w-[6px] -translate-y-1/2 rotate-45 border-r border-b"
                >
                </span>
              </div>
              <input
                ...
                class="text-body-color w-full bg-transparent py-3 pl-6 pr-[58px] text-base font-medium outline-none"
              />
              <button
                class="border-primary bg-primary absolute top-0 right-0 flex h-full w-[52px] items-center justify-center rounded-tr-md rounded-br-md border text-white"
              >
                <svg
                  width="27"
                  height="26"
          ...
          <div class="flex w-full items-center justify-end space-x-4">
            ...
            <div>
              <button
                class="text-dark relative flex h-10 w-10 items-center justify-center rounded-full border-[.5px] border-[#e7e7e7] bg-[#f4f7ff]"
              >
                <svg
                  width="20"
                  height="20"
            ...
            <div class="relative z-20">
              <div class="flex max-w-[200px] justify-end">
                ...
                >
                  ...
                  <span
                    class="bg-primary absolute -top-1 -right-1 h-4 w-4 rounded-full text-[10px] font-semibold text-white"
                  >
                    3
                  </span>
                </button>
              ...
              >
                <div
                  class="shadow-card overflow-hidden rounded-lg border border-[#e7e7e7] bg-white py-8 px-6"
                >
                  <div class="border-b border-[#e7e7e7] pb-3">
                    <div class="-mx-1 flex items-center justify-between pb-4">
                      <div class="flex items-center px-1">
                        ...
                        >
                          <img
                            src="https://cdn.tailgrids.com/1.0/assets/images/ecommerce/checkout/checkout-02/image-02.jpg"
                            alt="product image"
                            class="w-full"
                          />
                        </div>
                        <div>
                          ...
                          <p
                            class="text-body-color truncate text-xs font-medium"
                          >
                            Awesome white shirt
                          </p>
                        </div>
                    ...
                    <div class="-mx-1 flex items-center justify-between py-4">
                      <div class="flex items-center px-1">
                        ...
                        >
                          <img
                            src="https://cdn.tailgrids.com/1.0/assets/images/ecommerce/checkout/checkout-02/image-03.jpg"
                            alt="product image"
                            class="w-full"
                          />
                        </div>
            ...
            <div class="relative z-20">
              ...
              >
                <div
                  class="shadow-card overflow-hidden rounded-lg bg-white p-8"
                >
                    ...
                    <div class="-mx-1 flex items-center justify-between pb-4">
                      <div class="flex items-center px-1">
                        ...
                        <div>
                          <a
                            href="javascript:void(0)"
                            class="hover:text-primary text-sm font-medium text-black"
                          >
                            Circular Sienna
                          </a>
                          <p
      ...
      <div class="relative -mx-4 flex items-center justify-between">
        <div class="w-full max-w-full px-4 lg:w-60">
          <div class="relative py-4" @click.outside="categories = false ">
            <a
              ...
              class="bg-primary inline-flex items-center justify-between whitespace-nowrap rounded px-5 py-2 text-base font-medium text-white hover:bg-opacity-90"
            >
              <span class="pr-2">
                <svg
                  width="18"
            ...
            >
              ...
              <div class="px-6">
                <a
                  href="javascript:void(0)"
                  class="text-body-color hover:text-primary flex items-center justify-between rounded py-2 text-sm font-medium"
                >
                  Arts & Crafts
                </a>
              </div>
              <div class="group relative px-6">
                <a
                  ...
                  class="text-body-color hover:text-primary group-hover:text-primary flex items-center justify-between rounded py-2 text-sm font-medium"
                >
                  Fashion
                  <span>
                    <svg
                  ...
                  <div class="-mx-2 flex flex-wrap">
                    <div class="w-full px-2 lg:w-1/3">
                      <div>
                        ...
                        <a
                          href="javascript:void(0)"
                          class="text-body-color hover:text-primary block rounded py-2 text-sm font-medium"
                        >
                          Dresses
                        </a>
                        <a
        ...
        <div class="flex w-full items-center justify-between px-4">
          <div class="w-full">
            ...
            >
              <ul class="block items-center lg:flex">
                <li>
                  <a
                    href="javascript:void(0)"
                    class="text-dark hover:text-primary flex justify-between py-2 text-base font-medium lg:mx-5 lg:inline-flex lg:py-6 2xl:mx-6"
                  >
                    Mens
                  </a>
                </li>
                ...
                <li>
                  <a
                    href="javascript:void(0)"
                    class="text-dark hover:text-primary flex justify-between py-2 text-base font-medium lg:mx-5 lg:hidden lg:py-6 xl:inline-flex 2xl:mx-6"
                  >
                    News & Blogs
                  </a>
                </li>
